(function () {
  ...
  function n(a, c) {
    if (c)
      a: {
        ...
        c != d &&
          null != c &&
          k(b, a, { configurable: !0, writable: !0, value: c });
      }
  }
  function p(a) {
    var c =
    ...
    return a
      ...
      : function (c, b, d) {
          ...
          if ("function" == typeof e) {
            c = e.call(c);
            for (var h = 0; !(e = c.next()).done; )
              f.push(b.call(d, e.value, h++));
          } else
            for (e = c.length, h = 0; h < e; h++) f.push(b.call(d, c[h], h));
          return f;
        };
  });
  ...
  u.prototype.tick = function () {
    ...
    1 <= a - this.i &&
      (v(this, this.counter), (this.i = a), (this.counter = 0));
    ++this.counter;
  };
  function v(a, c) {
    a.g.shift();
  ...
  w.prototype.create = function (a, c, b) {
    ...
    (this.i = b.appendChild(document.createElement("span"))).classList.add(
      "callout"
    );
    ...
    c.range
      ? ((e.min = "" + c.range[0]),
        (e.max = "" + c.range[1]),
        (e.step = void 0 === c.step ? "any" : "" + c.step))
      : c.discrete &&
        ((e.min = "0"), (e.max = "" + (c.discrete.length - 1)), (e.step = "1"));
    e.oninput = function () {
