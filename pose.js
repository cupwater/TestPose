...
*/
  ...
  function H(a, c) {
    if (c)
      a: {
        ...
        c != d &&
          null != c &&
          E(b, a, { configurable: !0, writable: !0, value: c });
      }
  }
  H("Symbol", function (a) {
    function c(k) {
  ...
  H("Promise", function (a) {
    ...
    c.race = function (e) {
      return new c(function (g, h) {
        for (var m = J(e), q = m.next(); !q.done; q = m.next())
          d(q.value).I(g, h);
      });
    };
    c.all = function (e) {
  ...
  function ua(a, c) {
    ...
    if (void 0 === a.l) {
      ...
      a.h = {
        C: b.getAttribLocation(d, "aVertex"),
        B: b.getAttribLocation(d, "aTex"),
        S: f,
      };
      a.o = b.createBuffer();
        ...
        switch (l.g) {
          ...
          case 6:
            ...
            h = d.h.GL.createContext(d.j, {
              antialias: !1,
              alpha: !1,
              R: "undefined" !== typeof WebGL2RenderingContext ? 2 : 1,
            });
          ...
          case 8:
            if (d.g.listeners)
              for (p = J(d.g.listeners), y = p.next(); !y.done; y = p.next())
                (u = y.value), Ea(d, u);
            d.G = !1;
            l.g = 0;
        }
  ...
  C.setOptions = function (a) {
    ...
    if (this.g.options) {
      for (
        var b = [], d = [], f = {}, k = J(Object.keys(a)), e = k.next();
        !e.done;
        f = { J: f.J, K: f.K }, e = k.next()
      ) {
        var g = e.value;
        !(g in this.o && this.o[g] === a[g]) &&
          ...
          e.graphOptionXref &&
            ((g = {
              valueNumber: 0 === e.type ? a[g] : 0,
              valueBoolean: 1 === e.type ? a[g] : !1,
            }),
            (e = Object.assign(
              Object.assign(
        ...
        switch (r.g) {
          ...
          case 2:
            if (d.u) {
              ...
              m = J(d.u);
              for (q = m.next(); !q.done; q = m.next())
                (A = q.value), h.push_back(A);
              d.i.changeOptions(h);
              h.delete();
              d.u = void 0;
            }
                ...
                case "video":
                  ...
                  if (
                    ...
                    y instanceof HTMLImageElement
                      ? ((l = y.naturalWidth), (u = y.naturalHeight))
                      : ((l = y.width), (u = y.height));
                  ...
                  for (u = 0; u < y.length; ++u) {
                    ...
                    if (l.M)
                      for (var x = 0; x < l.M.length; ++x) {
                        var t = l.M[x],
                          w = t.visibility ? !0 : !1;
                        p.data.addNormalizedLandmark(
                          u,
                          Object.assign(Object.assign({}, t), {
                            hasVisibility: w,
                            visibility: w ? t.visibility : 0,
                          })
                        );
                      }
                    if (l.L)
        ...
        return V(a, function m() {
          ...
          return T(m, function (y) {
            if (1 == y.g) {
              ...
              if ((u = c.outs)) {
                for (
                  var l = {}, x = J(Object.keys(u)), t = x.next();
                  !t.done;
                  t = x.next()
                ) {
                  t = t.value;
                  ...
                  if ("string" === typeof w) l[t] = Ga(r, t, q[w]);
                    ...
                    if (void 0 !== v) {
                      if ("detection_list" === w.type) {
                        ...
                        l[t] = D;
                      } else if ("landmarks" === w.type)
                        (n = v.getLandmarks()), (l[t] = n ? X(n) : void 0);
                        ...
                        l[t] = n;
                      } else if ("texture" === w.type)
                        (n = r.m[t]),
                          n || ((n = new W(r.h, r.D)), (r.m[t] = n)),
                          (B = v.getTexture2d()),
                          ua(n, B),
                          (l[t] = n.i.canvas);
                      else
                        throw Error(
                          "Unknown output config type: '" + w.type + "'"
                        );
    ...
    this.g = new Y({
      ...
      files: function (b) {
        return [
          ...
          { data: !0, url: Ha(b.modelComplexity) },
        ];
      },
      graph: { url: "pose_web.binarypb" },
      listeners: [
        {
          wants: ["pose_landmarks", "image_transformed"],
          outs: {
      ...
      options: {
            ...
            return V(c, function f() {
              ...
              return T(f, function (m) {
                if (1 == m.g)
                  return (
                    (k = Ha(b)),
                    (e = "third_party/mediapipe/modules/pose_landmark/" + k),
                    Q(m, Z(g.g, k), 2)
                  );
                h = m.i;
        ...
        minTrackingConfidence: {
          ...
          graphOptionXref: {
            ...
            calculatorName:
              "poselandmarkgpu__poselandmarkbyroigpu__ThresholdingCalculator",
            fieldName: "threshold",
          },
        },
      },
